    ...
    return (
        ...
        >
            ...
            <button
                ...
                className={`grid h-6 w-6 shrink-0 place-items-center rounded-full border transition-all duration-200 ${task.completed
            ...
            <div className="min-w-0 flex-1">
                <AnimatePresence mode="wait" initial={false}>
                    {isEditing ? (
                        ...
                        >
                            <p
                                className={`truncate text-[15px] transition-colors duration-200 ${task.completed
                            ...
                            <div className="mt-1 flex flex-wrap items-center gap-2 text-xs font-medium">
                                <span
                                    className={`rounded-full px-2 py-0.5 ${task.completed
                                ...
                                <span
                                    className={`inline-flex items-center gap-1 rounded-full px-2 py-0.5 ${overdue
