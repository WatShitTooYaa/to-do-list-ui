  ...
  return (
    <main className="min-h-[calc(100vh-64px)] px-4 py-12">
      <section className="mx-auto max-w-2xl">
        <div className="mb-8">
          <div className="mb-4 grid h-12 w-12 place-items-center rounded-2xl bg-zinc-950 text-white dark:bg-zinc-50 dark:text-zinc-950">
            <UserRound size={20} />
          </div>
          <h1 className="text-3xl font-semibold text-zinc-950 dark:text-zinc-50">Profile</h1>
        ...
        <form
          ...
          className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-none"
        >
          ...
          <div className="mt-6 flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
            ...
            <button
              type="submit"
              className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-zinc-950 px-4 text-sm font-semibold text-white transition-colors hover:bg-zinc-800 dark:bg-zinc-50 dark:text-zinc-950 dark:hover:bg-zinc-200"
            >
              <Save size={16} />
              Save profile
            </button>
